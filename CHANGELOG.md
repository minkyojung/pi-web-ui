...
### Changed
- The count of notes that link to the one you are reading is gone from the strip at the foot of the window. What is left under the note is its tags, how much of it the agent wrote, and its length.
