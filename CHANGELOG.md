...
- Web access is a switch of its own in the tool menu, under the three modes: it is off when a conversation begins, turning it on lets the agent search and read the web in any mode, and it stays where you put it when you change mode.
