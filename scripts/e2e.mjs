...
// The other place the answer can be given: at the end of the header, over the document being read.
check("a document waiting for approval has the button at the end of its header, and it goes once it is approved", async ({ app, cwd }) => {
