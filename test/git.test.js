...
test("GitHub's pull requests are read by branch, with their checks folded and the rest read strictly", async () => {
	...
	assert.deepEqual([...map], [
		["me/x", { number: 30, state: "OPEN", url: "https://x/30", draft: false, review: "APPROVED", checks: { total: 3, pending: 1, failed: 1 }, merge: "", added: null, deleted: null, commits: null, method: "" }],
		["me/y", { number: 9, state: "CLOSED", url: null, draft: false, review: "", checks: { total: 0, pending: 0, failed: 0 }, merge: "", added: null, deleted: null, commits: null, method: "" }],
	]);
