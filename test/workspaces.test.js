...
test("a branch's status is its pull request's when it has one, else only whether the remote has it — never merged by git alone", () => {
	const bare = { url: null, draft: false, review: "", checks: { total: 0, pending: 0, failed: 0 }, merge: "", added: null, deleted: null, commits: null, method: "" };
	...
	const full = { number: 30, state: "OPEN", url: "https://x/30", draft: true, review: "APPROVED", checks: { total: 2, pending: 1, failed: 0 }, merge: "CLEAN", added: 5, deleted: 1, commits: 3, method: "SQUASH" };
	assert.deepEqual(statusOf({ onRemote: true, pr: full }), { state: "open", number: 30, url: "https://x/30", draft: true, review: "APPROVED", checks: { total: 2, pending: 1, failed: 0 }, merge: "CLEAN", added: 5, deleted: 1, commits: 3, method: "SQUASH" }, "what gh said of it goes along");
